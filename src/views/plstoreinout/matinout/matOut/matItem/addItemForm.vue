  ...
  >
    ...
    >
      ...
      <div class="section">
        ...
        <div class="form-row">
                    <el-form-item label="出库位置" prop="warehouse">
            <el-input 
...
import itemSelector from '../../../components/matInLitstSelector.vue';
...
const selectItem = (item) => {
  ...
  form.materialSpec = item.materialSpec;
  form.materialUnit = item.materialUnit;
  form.salesPrice = item.salesPrice;
  form.unitWeight = item.unitWeight;
  form.warehouse = item.warehouse;
  form.supplierName = item.supplierName;
  form.contractNo = item.contractNo;
...
const handleSave = async () => {
  try {
    ...
    quantity:  form.quantity ? -Math.abs(form.quantity) : form.quantity
   };
