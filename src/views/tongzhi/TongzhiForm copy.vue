    ...
    <el-form v-if="formLoaded" ref="formRef" :model="form" :rules="rules" label-width="80px" size="small">
      ...
      <el-card v-if="isEdit" class="form-card" shadow="never">
        ...
        <el-table :data="productList" border size="small" style="width: 100%">
          ...
          <el-table-column prop="itemSpec" label="规格型号" min-width="60" />
          <el-table-column prop="itemnum" label="数量" min-width="30" />
          <el-table-column prop="itemunit" label="单位" min-width="20" />
          <el-table-column prop="noticeid" label="通知编号" min-width="80" />
          <el-table-column prop="noticedrawno" label="图纸编号" min-width="80" />
          <el-table-column prop="noticeinstead" label="替代型号" min-width="80" />
          <el-table-column prop="noticename" label="通知名称" min-width="80" />
          <el-table-column prop="noticecomment" label="通知备注" min-width="80" />
    ...
    <el-dialog v-model="editDialogVisible" title="编辑产品信息" width="80%">
      <el-form ref="editFormRef" :model="editForm" :rules="editRules" label-width="80px" size="small">
        <el-row :gutter="12">
          <el-col :span="4">
            <el-form-item label="产品编号" prop="itemNo">
              <el-input v-model="editForm.itemNo" placeholder="产品编号" />
            </el-form-item>
          </el-col>
          <el-col :span="4">
            <el-form-item label="产品名称" prop="itemName">
              <el-input v-model="editForm.itemName" placeholder="产品名称" />
            </el-form-item>
          </el-col>
          <el-col :span="4">
            <el-form-item label="规格型号" prop="itemSpec">
              <el-input v-model="editForm.itemSpec" placeholder="规格型号" />
            </el-form-item>
          </el-col>
          <el-col :span="4">
            <el-form-item label="数量" prop="itemnum">
              <el-input-number v-model.number="editForm.itemnum" placeholder="数量" :min="1" />
            </el-form-item>
          </el-col>
          <el-col :span="4">
            <el-form-item label="单位" prop="itemunit">
              <el-input v-model="editForm.itemunit" placeholder="单位" />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="12">
          ...
          <el-col :span="4">
            <el-form-item label="替代型号" prop="noticestead">
...
const editRules = {
  itemNo: [{ required: true, message: '请输入产品编号', trigger: 'blur' }],
