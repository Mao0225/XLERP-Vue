  ...
  <div class="contract-management">
    ...
    <el-table :data="contractList" border v-loading="loading" style="width: 100%">
      ...
      <el-table-column label="操作" width="150" fixed="right">
        <template #default="{ row }">
          <el-button type="primary" size="small" @click="handleEdit(row)">制定通知</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-dialog v-model="showContractForm" :title="isEdit ? '制定通知' : '新增合同'" width="80%" top="5vh" destroy-on-close
      :before-close="handleBeforeClose">
      <TongzhiForm v-if="showContractForm" :contractNo="currentContractNo" @close="handleCloseContractForm" />
    </el-dialog>
...
import { getContractList, getContractInfoByNo, getBasContractItem } from '@/api/tongzhi/tongzhi.js'
import TongzhiForm from './TongzhiForm.vue'
