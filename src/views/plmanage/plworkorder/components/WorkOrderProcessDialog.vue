    ...
    <div class="dialog-content">
          ...
          >
            ...
            <div class="p-stat">
              ...
              <div class="qty-group">
                ...
                <span class="total">/{{ props.woAmount }}</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="report-section">
        ...
        >
          ...
          <!-- ================= 检验/入库工序 (Type 2) 列定义 ================= -->
          <template v-else-if="currentProcessType == 2">
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="工单号" style="margin-bottom: 0;">
                <span class="info-text">{{ props.woNo }}</span>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="订单号" style="margin-bottom: 0;">
                <span class="info-text">{{ props.ipoNo || '-' }}</span>
              </el-form-item>
            </el-col>
          </el-row>
        </div>
...
const props = defineProps({
  ...
  woNo: { type: String, required: true, default: '' },
  itemId: { type: [Number, String], default: null },
  woAmount: { type: Number, default: 0 },
