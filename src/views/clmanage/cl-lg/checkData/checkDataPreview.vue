          ...
          <el-row :gutter="16">
            <el-col :span="8" v-for="chem in chemicals" :key="chem.key">
              <el-form-item :label="chem.label">
                <el-row :gutter="8">
                  <el-col :span="12">
                    <el-form-item :label="chem.label + '实测值'">
                      <span>{{ initialData[chem.actualProp] || '-' }}</span>
                    </el-form-item>
                  </el-col>
                  <el-col :span="12">
                    <el-form-item :label="chem.label + '要求值'">
                      <span>{{ initialData[chem.requiredProp] || '-' }}</span>
                    </el-form-item>
                  </el-col>
                </el-row>
              </el-form-item>
            ...
            <el-row :gutter="16" style="width: 100%;">
              <el-col :span="6">
                <el-form-item label="要求值">
                  <span>{{ initialData.mechTSRequired || '-' }}</span>
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item label="实测值A">
                  <span>{{ initialData.mechTSA || '-' }}</span>
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item label="实测值B">
                  <span>{{ initialData.mechTSB || '-' }}</span>
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item label="实测值C">
                  <span>{{ initialData.mechTSC || '-' }}</span>
                </el-form-item>
              </el-col>
            </el-row>
          </el-form-item>
        ...
        <el-col :span="24">
          <el-form-item label="伸长率" label-width="120px">
            <el-row :gutter="16" style="width: 100%;">
              <el-col :span="6">
                <el-form-item label="要求值">
                  <span>{{ initialData.mechELRequired || '-' }}</span>
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item label="实测值A">
                  <span>{{ initialData.mechELA || '-' }}</span>
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item label="实测值B">
                  <span>{{ initialData.mechELB || '-' }}</span>
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item label="实测值C">
                  <span>{{ initialData.mechELC || '-' }}</span>
                </el-form-item>
              </el-col>
            </el-row>
          </el-form-item>
        ...
        <el-col :span="24">
          <el-form-item label="布氏硬度" label-width="120px">
            <el-row :gutter="16" style="width: 100%;">
              <el-col :span="6">
                <el-form-item label="要求值">
                  <span>{{ initialData.mechHBRequired || '-' }}</span>
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item label="实测值A">
                  <span>{{ initialData.mechHBA || '-' }}</span>
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item label="实测值B">
                  <span>{{ initialData.mechHBB || '-' }}</span>
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item label="实测值C">
                  <span>{{ initialData.mechHBC || '-' }}</span>
                </el-form-item>
              </el-col>
            </el-row>
          </el-form-item>
