        ...
        <el-col :span="12">
          <el-form-item label="材料" prop="material">
            <el-autocomplete v-model="form.material" :fetch-suggestions="queryMaterialSuggestions"
              placeholder="请选择或输入材料" clearable="" size="small">
            </el-autocomplete></el-form-item>
        </el-col>

        <el-col :span="12">
          <el-form-item label="圆钢牌号" prop="matMaterial">
            <el-input v-model="form.matMaterial" placeholder="请输入圆钢牌号" clearable="" size="small">
            </el-input></el-form-item>
        </el-col>
        <el-col :span="12">
