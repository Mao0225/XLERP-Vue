  ...
  >
    <el-form :model="initialData" label-width="120px" class="custom-form">
      <el-row :gutter="16">
        ...
        <el-col :span="12"><el-form-item label="圆钢牌号"><span>{{ initialData.matMaterial || '-' }}</span></el-form-item></el-col>
        ...
        <el-col :span="24">
          ...
          <el-row :gutter="16" style="margin-bottom: 12px;">
            ...
            <el-col :span="12"><el-form-item label="断后伸长率 要求值"><span>{{ initialData.mechelongationRequired || '-' }}</span></el-form-item></el-col>
          </el-row>
        </el-col>
