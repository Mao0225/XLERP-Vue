<template>
  <div class="steelplate-ingot-management">
    ...
    <el-table :data="steelplateIngotList" border v-loading="loading" style="width: 100%">
      ...
      <el-table-column prop="mechelongation1" label="延申率1#" width="90" />
      <el-table-column prop="mechelongation2" label="延申率2#" width="90" />
      <el-table-column prop="mechelongation3" label="延申率3#" width="90" />
...
import { getGbPage, deleteGb, getGbById, updateStatus } from '@/api/clmanage/cl-gb'
