<template>
  <el-dialog title="新增钢板数据" :model-value="visible" width="800px" :center="true" :close-on-click-modal="false"
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <el-form-item label="尺寸(厚宽长mm)" prop="size">
              ...
              <el-input v-model.number="form.size" placeholder="请输入尺寸(mm)" type="number" clearable size="small" step="0.01" />
        ...
        <el-col :span="8">
          <el-form-item label="Nb" prop="chemNb">
            <el-input v-model.number="form.chemNb" placeholder="Nb含量" clearable size="small" />
          </el-form-item>
        </el-col>

        <el-col :span="8">
          <el-form-item label="V" prop="chemV">
            <el-input v-model.number="form.chemV" placeholder="V含量" clearable size="small" />
          </el-form-item>
        </el-col>
        <el-col :span="8">
        ...
        <el-col :span="8">
          <el-form-item label="Mo" prop="chemMo">
            <el-input v-model.number="form.chemMo" placeholder="Mo含量" clearable size="small" />
          </el-form-item>
        </el-col>
        ...
        <el-col :span="8">
          <el-form-item label="断后伸长率" prop="elongation">
            <el-input v-model.number="form.elongation" placeholder="断后伸长率" clearable size="small" />
          </el-form-item>
        </el-col>
...
import { createGb } from '@/api/clmanage/cl-gb'
...
const rules = reactive({
  ...
  elongation: [
    { required: true, message: '请输入断后伸长率', trigger: 'blur' },
    { type: 'number', message: '必须为数字', trigger: 'blur' },
    { pattern: /^.{1,10}$/, message: '长度不能超过10个字符', trigger: 'blur' }
  ],
  bending: [
    { required: true, message: '请输入弯曲性能', trigger: 'blur' },
    { max: 50, message: '长度不能超过50个字符', trigger: 'blur' }
  ],
  impactexp: [
    { required: true, message: '请输入冲击实验', trigger: 'blur' },
    { max: 50, message: '长度不能超过50个字符', trigger: 'blur' }
  ],
  weight: [
    { type: 'number', message: '必须为数字', trigger: 'blur' }
