      ...
      <el-row :gutter="20">
        ...
        <el-col :span="8">
          <el-form-item label="抗拉强度" prop="tensileStrength">
            <el-input v-model="form.tensileStrength" placeholder="抗拉强度" clearable size="small" />
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="屈服强度" prop="yieldStrength">
            <el-input v-model="form.yieldStrength" placeholder="屈服强度" clearable size="small" />
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="延伸率" prop="elongation">
            <el-input v-model="form.elongation" placeholder="延伸率" clearable size="small" />
          </el-form-item>
        </el-col>
        ...
        <el-col :span="8">
          <el-form-item label="冲击测试1#" prop="impact1">
            <el-input v-model="form.impact1" placeholder="冲击测试1#结果" clearable size="small" />
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="冲击测试2#" prop="impact2">
            <el-input v-model="form.impact2" placeholder="冲击测试2#结果" clearable size="small" />
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="冲击测试3#" prop="impact3">
            <el-input v-model="form.impact3" placeholder="冲击测试3#结果" clearable size="small" />
          </el-form-item>
        </el-col>
...
import { updateWfg } from '@/api/clmanage/cl-wfg'
...
watch(() => props.initialData, (newData) => {
  if (newData && Object.keys(newData).length > 0) {
    Object.assign(form, {
      ...
      impact1: newData.impact1 || '',
      impact2: newData.impact2 || '',
      impact3: newData.impact3 || '',
