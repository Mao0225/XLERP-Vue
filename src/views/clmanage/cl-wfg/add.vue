<template>
  <el-dialog title="新增无缝管数据" :model-value="visible" width="800px" :center="true" :close-on-click-modal="false"
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <el-form-item label="外观尺寸" prop="appearanceSize">
            <el-input v-model="form.appearanceSize" placeholder="请输入外观尺寸" clearable size="small" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="8">
          <el-form-item label="C" prop="chemC">
            <el-input v-model.number="form.chemC" placeholder="C含量" clearable size="small" />
          </el-form-item>
        </el-col>
        <el-col :span="8">
        ...
        <el-col :span="8">
          <el-form-item label="P" prop="chemP">
            <el-input v-model.number="form.chemP" placeholder="P含量" clearable size="small" />
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="S" prop="chemS">
            <el-input v-model.number="form.chemS" placeholder="S含量" clearable size="small" />
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="Cr" prop="chemCr">
            <el-input v-model.number="form.chemCr" placeholder="Cr含量" clearable size="small" />
          </el-form-item>
        </el-col>
        ...
        <el-col :span="8">
          <el-form-item label="抗拉强度" prop="tensileStrength">
            <el-input v-model.number="form.tensileStrength" placeholder="抗拉强度" clearable size="small" />
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="屈服强度" prop="yieldStrength">
            <el-input v-model.number="form.yieldStrength" placeholder="屈服强度" clearable size="small" />
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="延伸率" prop="elongation">
            <el-input v-model.number="form.elongation" placeholder="延伸率" clearable size="small" />
          </el-form-item>
        </el-col>

        <!-- 冲击测试 -->
        <el-col :span="24">
          <el-divider content-position="left">冲击测试</el-divider>
        </el-col>
        <el-col :span="8">
          <el-form-item label="冲击测试1#" prop="impact1">
            <el-input v-model.number="form.impact1" placeholder="冲击测试1#结果" clearable size="small" />
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="冲击测试2#" prop="impact2">
            <el-input v-model.number="form.impact2" placeholder="冲击测试2#结果" clearable size="small" />
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="冲击测试3#" prop="impact3">
            <el-input v-model.number="form.impact3" placeholder="冲击测试3#结果" clearable size="small" />
          </el-form-item>
        </el-col>
        ...
        <el-col :span="12">
          <el-form-item label="入厂检测日期" prop="detectionTime">
            <el-date-picker v-model="form.detectionTime" type="date" placeholder="选择入厂检测日期" value-format="YYYY-MM-DD"
              size="small" style="width: 100%" />
          </el-form-item>
        </el-col>
...
import { createWfg } from '@/api/clmanage/cl-wfg'
...
const rules = reactive({
  ...
  chemC: [
    ...
    { pattern: /^.{1,10}$/, message: '长度不能超过10个字符', trigger: 'blur' }
  ],
  chemSi: [
  ...
  // 力学性能验证规则
  tensileStrength: [
    { required: true, message: '请输入抗拉强度', trigger: 'blur' },
    { type: 'number', message: '必须为数字', trigger: 'blur' }
  ],
  yieldStrength: [
    { required: true, message: '请输入屈服强度', trigger: 'blur' },
    { type: 'number', message: '必须为数字', trigger: 'blur' }
  ],
  elongation: [
    { required: true, message: '请输入延伸率', trigger: 'blur' },
    { type: 'number', message: '必须为数字', trigger: 'blur' }
  ],
  // 冲击测试验证规则
  impact1: [
    { required: true, message: '请输入冲击测试1#结果', trigger: 'blur' },
    { type: 'number', message: '必须为数字', trigger: 'blur' }
  ],
  impact2: [
    { required: true, message: '请输入冲击测试2#结果', trigger: 'blur' },
    { type: 'number', message: '必须为数字', trigger: 'blur' }
  ],
  impact3: [
    { required: true, message: '请输入冲击测试3#结果', trigger: 'blur' },
    { type: 'number', message: '必须为数字', trigger: 'blur' }
  ],
  // 日期验证规则
  leavefactoryDate: [
