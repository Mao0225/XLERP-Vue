...
import { getClbgxjsbxjlcList, getClbgxjsbxjlcById, createClbgxjsbxjlc, updateClbgxjsbxjlc, deleteClbgxjsbxjlc, getGongdanByWoNo,getBasNo } from '@/api/clmanage/clbgxjsbxjlc'
...
const handleAdd = async() => {
  ...
  if (nextBasNo.value) {
    ...
    try {
      const res = await getBasNo('clbgx');
      if (res.code === 200) {
