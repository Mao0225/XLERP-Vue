...
import { getClfzcfcList, getClfzcfcById, createClfzcfc, updateClfzcfc, deleteClfzcfc, getGongdanByWoNo,getBasNo } from '@/api/clmanage/clfzcfc'
...
const handleAdd = async() => {
  ...
  if (nextBasNo.value) {
    ...
    try {
      const res = await getBasNo('clfzcfc');
      if (res.code === 200) {
