...
import { getCljgbfcList, getCljgbfcById, createCljgbfc, updateCljgbfc, deleteCljgbfc, getGongdanByWoNo,getBasNo } from '@/api/clmanage/cljgbfc'
...
const handleAdd = async() => {
  ...
  if (nextBasNo.value) {
    ...
    try {
      const res = await getBasNo('cljgbfc');
      if (res.code === 200) {
