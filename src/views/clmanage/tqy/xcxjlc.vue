...
import { getXcxjLc, getXcxjLcById, createXcxjLc, updateXcxjLc, deleteXcxjLc , getWoNoList , getBasNo } from '@/api/clmanage/xcxjlc'
...
const handleAdd = async() => {
  ...
  try {
    ...
    if (nextBasNo.value) {
      ...
      const res = await getBasNo('xcxjlc') // 注意：这里的参数可能需要根据实际业务调整
      if (res.code === 200) {
