...
import { getNzxjFc, getNzxjFcById, createNzxjFc, updateNzxjFc, deleteNzxjFc , getWoNoList , getBasNo } from '@/api/clmanage/nzxjfc'
...
const handleAdd = async() => {
  ...
  try {
    ...
    if (nextBasNo.value) {
      ...
      const res = await getBasNo('nzxjfc') // 注意：这里的参数可能需要根据实际业务调整
      if (res.code === 200) {
