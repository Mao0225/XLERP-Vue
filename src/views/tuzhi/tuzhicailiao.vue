  ...
  <div class="tuzhicailiao-management">
    ...
    >
      <el-form ref="formRef" :model="form" :rules="rules" label-width="120px">
        ...
        <el-form-item label="录入者" prop="writer">
          <el-input v-model="form.writer" placeholder="请输入录入者" disabled />
        </el-form-item>
      </el-form>
      <template #footer>
    ...
    >
      <div class="search-bar">
        ...
        <el-input v-model="selectMaterialQueryParams.itemName" placeholder="按物料名称搜索" style="width: 200px;"></el-input>
...
const handleAdd = () => {
  ...
  form.writer = userInfo.value.username // 设置录入者为当前登录用户
...
const handleEdit = (row) => {
  ...
  form.writer = userInfo.value.username // 更新录入者为当前登录用户
  dialogVisible.value = true
}
...
const resetSelectMaterialForm = () => {
  ...
  selectMaterialQueryParams.itemName = ''
}
